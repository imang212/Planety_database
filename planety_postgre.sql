DROP TABLE IF EXISTS public."Typy_hvezd" CASCADE;
DROP TABLE IF EXISTS public."Typy_planet" CASCADE;
DROP TABLE IF EXISTS public."Typ_telesa" CASCADE;
DROP TABLE IF EXISTS public."Teleso" CASCADE;
DROP TABLE IF EXISTS public."Vzdalenost" CASCADE;
DROP TABLE IF EXISTS public."Objevitel" CASCADE;
DROP TABLE IF EXISTS public."Objev" CASCADE;
...
CREATE TABLE IF NOT EXISTS public."Typy_hvezd"(
    ...
    barva character varying(12) COLLATE pg_catalog."default" NOT NULL,
    "teplota_(K)" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."Typ_telesa"(
    ...
    id_hve integer,
    id_pla integer,
    CONSTRAINT "Typ_telesa_pkey" PRIMARY KEY (id_typ),
    CONSTRAINT fk_typ_hve FOREIGN KEY (id_hve)
        REFERENCES public."Typy_hvezd" (id_hve) MATCH SIMPLE
        ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."Teleso"(
    ...
    "max_teplota_(K)" integer,
    "rychlost_rotace_(km/h)" real,
    "perioda_(d)" real NOT NULL,
    id_mat_hve integer,
    id_pla integer,
    CONSTRAINT "Teleso_pkey" PRIMARY KEY (id_tel),
    CONSTRAINT fk_mat_hve FOREIGN KEY (id_mat_hve)
        REFERENCES public."Teleso" (id_tel) MATCH SIMPLE
        ON DELETE CASCADE,
    CONSTRAINT fk_mesic FOREIGN KEY (id_pla)
        REFERENCES public."Teleso" (id_tel) MATCH SIMPLE
        ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."Objevitel"(
    ...
    zeme_narozeni character varying(20) COLLATE pg_catalog."default" NOT NULL,
    misto_narozeni character varying(20) COLLATE pg_catalog."default" NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."Objev"(
    ...
    id_pla integer NOT NULL,
    id_jme integer,
    CONSTRAINT "Objev_pkey" PRIMARY KEY (id_obj, objevitel, id_pla),
    CONSTRAINT fk_jmeno FOREIGN KEY (id_jme)
        REFERENCES public."Objevitel" (id_jme) MATCH SIMPLE
        ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."Prvky"(
    ...
    protonove_cislo integer NOT NULL,
    relativni_atomova_hmotnost real NOT NULL,
...
CREATE TABLE IF NOT EXISTS public."Slouceniny"(
    ...
    id_prv1 integer NOT NULL,
    pocet_molekul_1 smallint NOT NULL,
    id_prv2 integer NOT NULL,
    pocet_molekul_2 smallint NOT NULL,
    CONSTRAINT "Slouceniny_pkey" PRIMARY KEY (id_slouc),
    CONSTRAINT fk_prv1 FOREIGN KEY (id_prv1)
...
CREATE TABLE IF NOT EXISTS public."Slozeni"(
    ...
    id_prv integer,
    id_slouc integer,
    "vyskyt_(%)" real NOT null,
    CONSTRAINT fk_prvek FOREIGN KEY (id_prv)
        REFERENCES public."Prvky" (id_prv) MATCH SIMPLE
        ON DELETE CASCADE,
    CONSTRAINT fk_sloucenina FOREIGN KEY (id_slouc)
        REFERENCES public."Slouceniny" (id_slouc) MATCH SIMPLE
        ON DELETE CASCADE,
...
INSERT INTO "Typy_planet" VALUES (1,'kamenná planeta'),(2,'plynný obr'),(3,'trpasličí planeta'),(4,'kamenný měsíc'),
(5,'asteroid'),(6,'kometa');

INSERT INTO "Typ_telesa" VALUES (1,'hvězda',1,NULL),(2,'hvězda',2,NULL),(3,'hvězda',3,NULL),(4,'hvězda',4,NULL),
...
(null,38.271,67.864,33),(268521613.32, null, null, 34),(null,0.59278,35.14,35);

INSERT INTO "Objevitel" VALUES
...
(35,null, 'Starověká čína',35,null);

INSERT INTO "Prvky" VALUES 
